...
- Apple Silicon local starts build and launch arm64 Ghostex resources even from a Rosetta shell, and stale zmx/zehn command-line artifacts rebuild when their architecture does not match the requested app build.
